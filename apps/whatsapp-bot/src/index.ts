// Main application entry point for WhatsApp AI Bot
import { WhatsAppBotCore } from "@whatsapp-ai/core";
...
// Main application
class Application {
  private bot: WhatsAppBotCore | null;
